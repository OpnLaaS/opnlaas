...
export const known_uri = {
    ...
    enum_distroTypes: () => "/api/enums/distro-types",
    ...
    enum_bookingRequestStatuses: () => "/api/enums/booking-request-statuses",
    hosts_hosts: () => "/api/hosts",
    hosts_hostByManagementIP: (management_ip) => `${known_uri.hosts_hosts()}/${management_ip}`,
    hosts_hostReprobeSystemInfo: (management_ip) => `${known_uri.hosts_hostByManagementIP(management_ip)}/reprobe-system-info`,
    hosts_hostPowerAction: (management_ip, power_action) => `${known_uri.hosts_hostByManagementIP(management_ip)}/power/${power_action}`,
    operations_operationByID: (operation_id) => `/api/operations/${encodeURIComponent(operation_id)}`,
    iso_images: () => "/api/iso-images",
    iso_imagesByName: (name) => `${known_uri.iso_images()}/${encodeURIComponent(name)}`,
    bookings: () => "/api/bookings",
    bookings_mine: () => "/api/bookings/me",
    bookings_networkPrefill: () => "/api/bookings/network/prefill",
    bookings_deploy: () => "/api/bookings/deploy",
    bookings_bookingByID: (booking_id) => `${known_uri.bookings()}/${booking_id}`,
    bookings_provisioningByID: (booking_id) => `${known_uri.bookings_bookingByID(booking_id)}/provisioning`,
    bookings_provisioningCancelByID: (booking_id) => `${known_uri.bookings_provisioningByID(booking_id)}/cancel`,
    bookings_cart: () => "/api/bookings/cart",
    bookings_cartNetwork: () => "/api/bookings/cart/network",
    bookings_cartHosts: () => "/api/bookings/cart/hosts",
    bookings_cartHostByIP: (management_ip) => `${known_uri.bookings_cartHosts()}/${management_ip}`,
    bookings_availableCartHosts: () => "/api/bookings/cart/hosts/available",
};
